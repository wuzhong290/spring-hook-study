 ...
 */
package com.demo.javabase.nio.util;
...
public class ExecutorUtil {
    ...
    public static final ScheduledExecutorService scheduledExecutorService(String name, int size, boolean isDaemon){
        NameableThreadFactory factory = new NameableThreadFactory(name, isDaemon);
        ScheduledExecutorService scheduledExecutorService = new ScheduledThreadPoolExecutor(size,factory);
